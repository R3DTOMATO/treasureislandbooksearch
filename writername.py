...
def app():
    def writer():
        url="https://drive.google.com/file/d/1TcmkXyB4JQQJJhqwq87QbO3N9Y_isdPM/view?usp=sharing"
        response = urllib.request.urlopen(url)
        df = pd.read_csv("도서정보.csv")
        return df.set_index("작가")

    try:
        urllib.request.urlopen("https://drive.google.com/file/d/1TcmkXyB4JQQJJhqwq87QbO3N9Y_isdPM/view?usp=sharing")
        df = writer()
